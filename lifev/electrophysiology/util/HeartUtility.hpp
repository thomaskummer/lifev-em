 ...
 */
template<typename Mesh> inline void importFibers (  std::shared_ptr<VectorEpetra> fiberVector, const std::string& fileName, std::shared_ptr< Mesh > localMesh, const std::string& filePath = "./", const std::string& polynomialDegree = "P1" )
{
    ...
    std::shared_ptr<FESpace< mesh_Type, MapEpetra > > fiberSpace ( new FESpace< mesh_Type, MapEpetra > ( localMesh, polynomialDegree, 3, comm ) );
 ...
 * @param localMesh   Pointer to the mesh
 */
template<typename Mesh> inline void importScalarField (  std::shared_ptr<VectorEpetra> vector,
                                                         ...
                                                         const std::string& timestep = "00000" )
{
    ...
    std::shared_ptr<Epetra_Comm>  comm ( new Epetra_MpiComm (MPI_COMM_WORLD) );
    std::shared_ptr<FESpace< mesh_Type, MapEpetra > > feSpace ( new FESpace< mesh_Type, MapEpetra > ( localMesh, polynomialDegree, 1, comm ) );
 ...
 * @param localMesh   Pointer to the mesh
 */
template<typename Mesh> inline void importVectorField (  std::shared_ptr<VectorEpetra> vector,
		                                                 const std::string& fileName,
		                                                 const std::string& fieldName,
		                                                 std::shared_ptr< Mesh > localMesh  ,
		                                                 const std::string& postDir = "./",
                                                         ...
                                                         const std::string& timestep = "00000" )
{
    ...
    std::shared_ptr<Epetra_Comm>  comm ( new Epetra_MpiComm (MPI_COMM_WORLD) );
    std::shared_ptr<FESpace< mesh_Type, MapEpetra > > feSpace ( new FESpace< mesh_Type, MapEpetra > ( localMesh, polynomialDegree, 3, comm ) );
